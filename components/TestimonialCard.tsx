...
const TestimonialCard = () => {
  return (
    <Card className="max-w-[280px] min-h-[320px] md:!max-w-md p-3 bg-slate-200 first:ms-5"> 
      ...
      <CardBody className="px-3 py-0 text-small text-default-400 h-auto">
        <p className="font-Lato text-base tracking-tight">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
      </CardBody>
